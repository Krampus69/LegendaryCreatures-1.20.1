...
public class HoundEntity extends AnimatedCreatureEntity implements Enemy {
    ...
    protected void registerGoals() {
        ...
        RootMeleeAttackGoal rootMeleeAttackGoal = new RootMeleeAttackGoal(this, this.biteAttackDuration, this.biteAttackActionPoint, biteLongAttackDuration * 3, 3.0f,   0.3, 1.0f, 120) {
            @Override
            protected double getAttackReachSqr(LivingEntity entity) {
                return (double) (getMobLength() * 2.0F * getMobLength() * 2.0F + entity.getBbWidth());
            }
