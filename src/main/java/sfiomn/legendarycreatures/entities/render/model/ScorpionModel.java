...
public class ScorpionModel extends GeoModel<ScorpionEntity> {
    ...
    public ResourceLocation getTextureResource(ScorpionEntity entity) {
        if (entity.isLevel2() && entity.hasBabies()) return texture_level2_babies;
        if (entity.isLevel2())                       return texture_level2;
        if (entity.hasBabies())                      return texture_level1_babies;
