...
public class ModBusEvents {
    ...
    public static void addEntityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(EntityTypeRegistry.JINX.get(), JinxEntity.setCustomAttributes().build());
        event.put(EntityTypeRegistry.FROGMAN.get(), FrogmanEntity.setCustomAttributes().build());
        event.put(EntityTypeRegistry.SHROOMLING.get(), ShroomlingEntity.setCustomAttributes().build());
