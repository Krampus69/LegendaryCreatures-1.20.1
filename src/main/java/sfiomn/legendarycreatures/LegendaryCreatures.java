...
import sfiomn.legendarycreatures.particles.SleepingParticle;
...
public class LegendaryCreatures
{
    ...
    public static MobCategory LEGENDARY_HOSTILE_CREATURE = MobCategory.create("legendary_hostile_creature", "LEGENDARY_HOSTILE_CREATURE", 5, false, false, 128);
    ...
    public static class ClientModEvents {
        ...
        public static void onRegisterEntityRenderers(EntityRenderersEvent.RegisterRenderers  event) {
            ...
            event.registerEntityRenderer(EntityTypeRegistry.JINX.get(), JinxRenderer::new);
        ...
        public static void registerParticleFactories(RegisterParticleProvidersEvent event) {
            ...
            event.registerSpriteSet(ParticleTypeRegistry.SLEEPING_PARTICLE.get(), SleepingParticle.Factory::new);
        }
